  ...
  const pengurus = [
    {
      nama: 'Sarmin Arifin',
      jabatan: 'Ketua',
      foto: '/img/img-1.jpeg', // Ganti dengan path foto lokal atau URL baru
      deskripsi: 'Mahasiswa Akut, aktif dalam organisasi sejak 1997'
    },
    {
      nama: 'Dzoe Saputra',
      jabatan: 'Wakil Ketua',
      foto: '/images/dzoe.jpg', // Ganti dengan path foto lokal atau URL baru
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Mengenal lebih dekat organisasi pemuda Kampung Iim Balap yang berdedikasi untuk kemajuan desa
          </p>
        </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-10 hover:shadow-2xl transition-all duration-300">
            ...
            <div className="prose prose-xl text-gray-700 max-w-none">
              <p className="mb-6 text-lg" style={{lineHeight: '1.8', paddingBottom: '0.5rem'}}>
                Karang Taruna Kampung Iim Balap didirikan pada tahun 2010 dengan semangat untuk memberdayakan 
              ...
              <p className="text-lg" style={{lineHeight: '1.8', paddingBottom: '0.5rem'}}>
                Dalam perjalanannya, Karang Taruna Kampung Iim Balap telah berhasil melaksanakan berbagai 
